...
\t\t\t\t\t<mj-link href=\"http://localhost/projet4/dev/?id=";
        ...
        echo "&etat=";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["annonce"] ?? null), "etat", [], "any", false, false, false, 33), "html", null, true);
        echo "\">confirmer la creation</mj-link>
\t\t\t\t\t<mj-link href=\"http://localhost/projet4/dev/?id=";
        // line 34
        ...
        echo "&etat=";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["annonce"] ?? null), "etat", [], "any", false, false, false, 34), "html", null, true);
        echo "\">modifier l'annonce</mj-link>
\t\t\t\t\t<p></p>
\t\t\t\t</mj-text>
\t\t\t</mj-column>
\t\t</mj-section>
...
";
    ...
    {
        return array (  92 => 34,  86 => 33,  82 => 32,  76 => 29,  71 => 27,  64 => 23,  59 => 21,  37 => 1,);
    }
